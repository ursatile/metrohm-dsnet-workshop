...
inline const std::string& HelloRequest::language() const {
  // @@protoc_insertion_point(field_get:example.HelloRequest.language)
  return _internal_language();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void HelloRequest::set_language(ArgT0&& arg0, ArgT... args) {
 ...
 language_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:example.HelloRequest.language)
}
inline std::string* HelloRequest::mutable_language() {
  std::string* _s = _internal_mutable_language();
  // @@protoc_insertion_point(field_mutable:example.HelloRequest.language)
  return _s;
}
...
inline std::string* HelloRequest::release_language() {
  // @@protoc_insertion_point(field_release:example.HelloRequest.language)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:example.HelloRequest.language)
}
...
inline const std::string& HelloReply::greeting() const {
  // @@protoc_insertion_point(field_get:example.HelloReply.greeting)
  return _internal_greeting();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void HelloReply::set_greeting(ArgT0&& arg0, ArgT... args) {
 ...
 greeting_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:example.HelloReply.greeting)
}
inline std::string* HelloReply::mutable_greeting() {
  std::string* _s = _internal_mutable_greeting();
  // @@protoc_insertion_point(field_mutable:example.HelloReply.greeting)
  return _s;
}
...
inline std::string* HelloReply::release_greeting() {
  // @@protoc_insertion_point(field_release:example.HelloReply.greeting)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:example.HelloReply.greeting)
}
